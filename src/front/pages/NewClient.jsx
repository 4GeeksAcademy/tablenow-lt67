...
function NewClient() {
    ...
    function sendData(e) {
        ...
        fetch(import.meta.env.VITE_BACKEND_URL + "/api/clients", requestOptions)
        ...
        <div className="new-client-wrapper">
            ...
            <div className="form-container-luxury content-relative">
                <div className="form-header">
                    ...
                    <span className="brand-badge-alt">Exclusive Access</span>
                    <h1 className="form-title">Create <span className="text-gold">Client</span> Account</h1>
                </div>
